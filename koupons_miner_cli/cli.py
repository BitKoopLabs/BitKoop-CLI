#!/usr/bin/env python3
"""Koupons CLI - Command-line interface for Koupons mining operations"""
...
from koupons_miner_cli.commands import (
    delete_code_command,
    recheck,
    sites,
    submit_code_command,
...
def setup_submit_code(parser):
    ...
    parser.add_argument("code", help="Coupon code to submit")
...
def setup_view_codes(parser):
    ...
    parser.epilog = """
Examples:
  koupons view-codes                    # View all valid coupons
  koupons view-codes amazon.com         # View coupons for a specific site
  koupons view-codes --category electronics
  koupons view-codes --page 2 --limit 20
  koupons view-codes --wallet.name my_wallet
"""
...
def setup_list_sites(parser):
    ...
    parser.add_argument("--miner", help="Filter by miner hotkey")
    ...
    parser.add_argument("--show-miners", action="store_true", help="Show miner hotkeys")
    parser.epilog = """
Examples:
  koupons list-sites --limit 5
  koupons list-sites --domain amazon
  koupons list-sites --sort-by store_domain
"""
    parser.formatter_class = argparse.RawDescriptionHelpFormatter
...
def setup_list_categories(parser):
    ...
    parser.epilog = """
Examples:
  koupons list-categories --name electro
  koupons list-categories --limit 10 --page 2
"""
    parser.formatter_class = argparse.RawDescriptionHelpFormatter
