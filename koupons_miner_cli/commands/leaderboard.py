"""
Leaderboard command for the Koupons CLI.
"""

from koupons_miner_cli.business import ranking as ranking_business
from koupons_miner_cli.utils.display import display_panel, display_table
from koupons_miner_cli.utils.formatting import format_leaderboard_data


def leaderboard_command(args):
    """Show ranks and scores of all miners"""
    display_panel("Leaderboard", "Koupons Mining Leaderboard", border_style="blue")
    ...
    display_table("Koupons Mining Leaderboard", columns, rows)
