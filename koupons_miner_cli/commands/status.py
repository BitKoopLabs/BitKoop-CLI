"""
View status command for the Koupons CLI.
"""

from koupons_miner_cli.business import status as status_business
from koupons_miner_cli.utils.display import display_panel, display_table
from koupons_miner_cli.utils.formatting import format_status_data
