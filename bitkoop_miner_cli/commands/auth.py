"""
Authentication command for the bitkoop CLI.
"""
...
from bitkoop_miner_cli.business import auth as auth_business
...
def auth_command(args: Namespace):
    ...
    display_panel(
        "Auth", "Starting bitkoop authentication process...", border_style="blue"
    )
